...
#define PWM_CTL_MSEN1   (1<<7)  // Chan 1: M/S transmission
#define PWM_ENAB1       1       // Enable PWM channel 1

#define PWM_CTL_RPTL2   (1<<10) // Chan 2: repeat last data when FIFO empty
#define PWM_CTL_POLA2   (1<<12) // Chan 2: polarity
#define PWM_CTL_USEF2   (1<<13) // Chan 2: use FIFO
#define PWM_CTL_MSEN2   (1<<15) // Chan 2: M/S transmission
